...
@RooJavaBean
@RooToString
@RooJpaActiveRecord(finders = { "findPropertysByEntity", "findPropertysByEntityAndNameLike" })
public class Property {
    ...
    public boolean isValidConfiguration() {
        if (Pattern.matches("[a-zA-Z0-9 _]+", this.configuration) || this.configuration.equals("")) {
            return true;
        } else {
            return false;
        }
    ...
    public static com.nanuvem.lom.model.Property findProperty(Long id) {
        ...
        if (property == null) {
            throw new PropertyNotFoundException("Property not found with this id!");
        }
        return property;
    }

    public static TypedQuery<com.nanuvem.lom.model.Property> findPropertysByEntity(Entity entity) {
